...
acoustic_thres = 85 #85 #85 #80 #70 #80 #75

ranges = np.linspace(minR, maxR, binsR)
# sonar_idx_arr = np.arange(-binsA/2+1, binsA/2+1, 1)
sonar_idx_arr = np.arange(-binsA/2, binsA/2, 1)
...
class AutoCalibration():
    def __init__(self, images, images_depth, sonars, masks, init_params, config, max_iters = 300, gt_params=None,  params_grid=None):
